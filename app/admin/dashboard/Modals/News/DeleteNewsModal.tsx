...
interface News { _id: string; title: string; }
interface Props { news: News; }

export default function DeleteNewsModal({ news }: Props) {
    ...
    const handleDelete = async () => {
        setDeleting(true);
        try {
            const res = await fetch(`/api/news/delete?id=${news._id}`, { method: 'DELETE' });
        ...
        <div className="p-6 sm:p-8 max-w-md mx-auto">
            <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-slate-900 leading-tight">Delete News</h3>
            ...
            <div className="mt-6 space-y-5 text-center">
                ...
                <div>
                    <p className="text-base text-slate-700">Delete this news article?</p>
                ...
                <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl w-full">
                    <p className="text-sm font-medium text-slate-900 line-clamp-2 leading-tight">"{news.title}"</p>
                </div>
            </div>
